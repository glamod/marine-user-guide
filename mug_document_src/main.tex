...
%\usepackage{changes}
%\definechangesauthor[name=Axel]{AA}
%\definechangesauthor[name=Tina]{TL}
%\definechangesauthor[name=Ludwig]{LL}
...
\newcommand{\datatimerange}{{1851 - 2023}} % define data time range for figures etc.
\newcommand{\inventoryref}{{C3S2\_D311\_Lot1.2.3.1.2024\_Updated Inventory for Marine datasets\_v4}}
...
% use Carlito as font-metric compatible replacement fallback
\setmainfont{Carlito}
\setsansfont{Carlito}
...
\lfoot{C3S2\_311\_Lot1\_NUIM\_2021/SC2–Ninth version Marine User Guide}
\cfoot{}
