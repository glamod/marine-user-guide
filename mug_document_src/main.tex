...
% Set document root
%old: /Users/dyb/GitHub/user_guide/C3S_Marine_PUG/main.tex
% !TEX root = /data/repros/marine-user-guide.2022/mug_document_src/main.tex
% ======================================
...
\newcommand{\datatimerange}{{1851 - 2022}} % define data time range for figures etc.
\newcommand{\inventoryref}{{C3S2\_D311\_Lot1.2.3.1.202308\_Updated Inventory for Marine datasets\_v3}}
...
\lfoot{C3S2\_311\_Lot1\_NUIM\_2021/SC2–Eighth version Marine User Guide}
\cfoot{}
...
\subfile{mug_document_src/sections/cover_page.tex}
\newpage\subfile{mug_document_src/sections/front_matter.tex}
 \newpage\subfile{mug_document_src/sections/contributors.tex}
\renewcommand{\contentsname}{\color{maroon}{Contents}}
\newpage\tableofcontents\thispagestyle{fancy}
\newpage\subfile{mug_document_src/sections/change_log.tex}
